...
function DialogKey:OnInitialize()				-- Runs on addon initialization
	...
	--self.frame:EnableKeyboard(true) -- Locks out the keyboard entirely if below row is not working
	--self.frame:SetPropagateKeyboardInput(true) -- Need to do similar in 3.3.5 someway, this method doesn't exist in 3.3.5 wow api.
