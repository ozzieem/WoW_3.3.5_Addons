...
{
	[" and "] = " et ",
	["%d of %d stacks remain"] = "%d stacks restant sur %d",
	["%s has expired on %s"] = "%s a expiré sur %s",
	...
	["No Auto-cast"] = "Pas d'auto-incantation",
	["Rebuff prelude for %s (0=Module default)"] = "Rebuff préventif pour %s (0=valeur par défaut)",
	["Remember this spell when it's cast manually?"] = "Se rappeler de ce sort quand il est lancé manuellement ?",
	Reset = "Réinitialiser",
	["Select a soundfile to play when player's tracked buff expires"] = "Selectionner un fichier audio à joueur quand le buff suivi du joueur expire",
