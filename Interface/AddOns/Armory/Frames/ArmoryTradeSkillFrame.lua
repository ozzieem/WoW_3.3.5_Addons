--[[
    ...
    Revision: 191 2009-12-17T23:38:35Z
...
function ArmoryTradeSkill_Update()
    ...
    if ( ArmoryTradeSkillFrame.isOpen and not IsTradeSkillLinked() ) then
        ArmoryTradeSkillFrame:UnregisterEvent("TRADE_SKILL_UPDATE");
        ...
        ArmoryTradeSkillFrame:RegisterEvent("TRADE_SKILL_UPDATE");
    
        if ( Armory.character == Armory.player and ArmoryTradeSkillFrame.skillName == currentSkill and ArmoryTradeSkillFrame:IsShown() ) then
            if ( modeChanged ) then
