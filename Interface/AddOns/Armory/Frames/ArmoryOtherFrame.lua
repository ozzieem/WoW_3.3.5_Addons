--[[
    ...
    Revision: 265 2010-04-12T09:16:06Z
...
ARMORY_OTHER_TABS = {REPUTATION_ABBR, SKILLS_ABBR, RAID, CURRENCY};

ARMORY_OTHERFRAME_SUBFRAMES = { "ArmoryReputationFrame", "ArmorySkillFrame", "ArmoryRaidInfoFrame", "ArmoryTokenFrame" };
...
function ArmoryOtherFrameTab_Update()
    ...
    firstTab, numTabs = TabAdjust(2, Armory:HasSkills(), firstTab, numTabs);
    firstTab, numTabs = TabAdjust(3, Armory:RaidEnabled(), firstTab, numTabs);
    firstTab, numTabs = TabAdjust(4, Armory:HasCurrency(), firstTab, numTabs);
