--[[
    ...
    Revision: 279 2010-06-03T22:48:52Z
...
function ArmoryFindFrame_Initialize(searchType, search)
...
function ArmoryFindFrame_Add(who, where, what, link, count)
    table.insert(ARMORY_FIND_RESULTS, {who=who, where=where, what=what, link=link, count=count});
end
...
function ArmoryFindType_CreateButtons(onClick)
    ...
    for _, value in ipairs({ARMORY_CMD_FIND_ALL, ARMORY_CMD_FIND_INVENTORY, ARMORY_CMD_FIND_ITEM, ARMORY_CMD_FIND_QUEST, ARMORY_CMD_FIND_SPELL, ARMORY_CMD_FIND_SKILL, ARMORY_CMD_FIND_ACHIEVEMENT}) do
