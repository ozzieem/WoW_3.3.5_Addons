...
L["ARMORY_CMD_FIND_ACHIEVEMENT"] = "achievement"
...
L["ARMORY_CMD_SET_FILTERALL_MENUTEXT"] = "Filter all messages"
L["ARMORY_CMD_SET_FILTERALL_TEXT"] = "filter all Armory output"
L["ARMORY_CMD_SET_FILTERALL_TOOLTIP"] = "If enabled, all output will be sent to the same chat frame (only meaningful if you use a separate chat window for Armory messages)."
...
L["ARMORY_CMD_SET_SHOWRECIPEKNOWN_MENUTEXT"] = "Show known recipes in tooltips"
L["ARMORY_CMD_SET_SHOWRECIPEKNOWN_TEXT"] = "show known recipes in tooltips"
L["ARMORY_CMD_SET_SHOWRECIPEKNOWN_TOOLTIP"] = "If enabled, recipe tooltips will show which character already knows the recipe."
...
L["ARMORY_MESSAGE_FILTER"] = "Message Filter"
