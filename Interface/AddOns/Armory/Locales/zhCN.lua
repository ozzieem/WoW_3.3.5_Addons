...
L["ARMORY_CMD_SET_FILTERALL_MENUTEXT"] = "过滤所有信息"
L["ARMORY_CMD_SET_FILTERALL_TEXT"] = "过滤所有 Armory 输出"
L["ARMORY_CMD_SET_FILTERALL_TOOLTIP"] = "如果打开此功能, 所有输出信息将被发送在同一个聊天窗体 (意味着如果你使用一个分开的聊天窗口显示Armory的信息)."
