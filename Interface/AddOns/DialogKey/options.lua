function DialogKey:CreateOptionsFrame()		-- Constructs the options frame
	...
	local additionalScroll = CreateFrame("EditBox", "DialogKeyScrollFrame", optionsContent, "InputBoxTemplate")
	...
	print(newValue)
	additionalScroll:SetText(newvalue)
	additionalScroll:SetMaxLetters(0)
	additionalScroll:SetWidth(additionalScroll:GetWidth())
	--additionalScroll:Enable()
	additionalScroll:SetFont("Fonts\\ARIALN.TTF", 16)
	
	additionalScroll:SetScript("OnEnterPressed", nil)
	...
	-- Dialog blacklist
	local blacklistScroll = CreateFrame("EditBox", "DialogKeyScrollFrame", optionsContent, "InputBoxTemplate")
	...
	blacklistScroll:SetText(blacklistValue)
	blacklistScroll:SetMaxLetters(0)
	blacklistScroll:SetWidth(blacklistScroll:GetWidth())
	--blacklistScroll:Enable()
	blacklistScroll:SetFont("Fonts\\ARIALN.TTF", 16)
	
	blacklistScroll:SetScript("OnEnterPressed", nil)
	...
	cooldownSlider:SetValueStep(0.2)
	cooldownSlider.scrollStep = 0.2
