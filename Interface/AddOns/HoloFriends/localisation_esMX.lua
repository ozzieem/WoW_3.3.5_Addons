...
HOLOFRIENDS_HOMEPAGEAIM = "Este addon modifica la ventana de amigos de WoW ofreciendo una mejor manejo de la lista de amigos y de la lista de personajes ignorados.";
...
HOLOFRIENDS_LISTFEATURES0TITLE = "Caracter\195\173sticas";
...
HOLOFRIENDS_MSGDELETECHARNOTFOUND = "%s no encontrado, por favor revise la escritura u ortograf\195\173a";

HOLOFRIENDS_MSGFRIENDLIMITALERT = "Ud puede monitorear unicamente %d amigos!";
HOLOFRIENDS_MSGFRIENDONLINEDISABLED = "El monitoreo el l\195\173nea de %s desabilitada"; -- Needs review
HOLOFRIENDS_MSGFRIENDONLINEENABLED = "Monitoreo en l\195\173nea de %s habilitado"; -- Needs review
...
HOLOFRIENDS_WINDOWMAINNUMBERONLINE = "Amigos en L\195\173nea:";
