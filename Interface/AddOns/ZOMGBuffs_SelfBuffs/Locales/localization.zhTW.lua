...
--@end-debug@]===]
{
	...
	["Expiry Prelude"] = "失效預知",
	["Expiry prelude for flasks"] = "精煉藥劑到期前的提示",
	["Flask of the North"] = "北方精鍊藥劑",
	["Item configuration"] = "物品配置",
	Items = "物品",
	Learnable = "可學習",
	["Main Hand"] = "主手",
	["Minimum Charges"] = "最少的數額",
	["Off Hand"] = "副手",
	["Reagent Reminder"] = "材料提醒",
	["Rebuff if number of charges left is less than defined amount"] = "如果低於規定的數額時就rebuff",
	...
	["Special handling for Flask of the North"] = "北方精鍊藥劑的特別處理",
