...
--@end-debug@]===]
{
	...
	["Flask of the North"] = "Flacon du Grand Nord",
	["Item configuration"] = "Configurations des objets",
	Items = "Objets",
	["Main Hand"] = "Main principale",
	["Minimum Charges"] = "Charges minimum",
	["Off Hand"] = "Main secondaire",
	["Reagent Reminder"] = "Pense-bête réactifs",
	["Rebuff if number of charges left is less than defined amount"] = "Rebuff si le nombre de charges restantes est inférieur au montant défini",
	["Rebuff prelude for %s (0=Module default)"] = "Rebuff préventif pour %s (0=valeur par défaut)",
	["Remember this spell when it's cast manually?"] = "Se rappeler de ce sort lorsqu'il est lancé manuellement ?",
	Seals = "Sceau",
	Self = "personnel",
