...
local status, death, unknown = "|cff39d7e5Death: %s|r", "Death: %s > %s", "Death: %s%s > Unknown"
local limit = "|cffffff00(%s) Le rapport ne peut pas être envoyé parce qu'il excède la limite de caractère maximale de 255. Pour réparer, diminuer EVENT_HISTORY dans Fatality.lua et /reload votre UI.|r"
